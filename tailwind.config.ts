  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "sticker-pink": "hsl(var(--sticker-pink))",
        "sticker-yellow": "hsl(var(--sticker-yellow))",
        "sticker-sky": "hsl(var(--sticker-sky))",
        "sticker-lavender": "hsl(var(--sticker-lavender))",
      ...
      animation: {
        ...
        "sticker-bounce": "sticker-bounce 0.2s ease-in-out",
        "sticker-float": "sticker-float 2s ease-in-out infinite",
